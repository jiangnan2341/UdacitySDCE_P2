...
model = "fpn-resnet" #"darknet","fpn-resnet"
model_brev = "resnet" #"darknet" , "resnet"
sequence = "1" # options are "1", "2", "3"
#results_fullpath = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'results/' + model + '/results_sequence_' + sequence + '_' + model)
results_fullpath = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'results/' + model + '/results_sequence_' + sequence + '_' + model_brev)
